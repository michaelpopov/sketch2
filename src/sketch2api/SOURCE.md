...
- `sketch2api.cpp`: C API implementation for dataset lifecycle, updates, queries, and text/binary bulk generation or loading.
- `sketch2api.h`: Public C API declarations exposed by sketch2api, including text and binary bulk-ingest helpers.
