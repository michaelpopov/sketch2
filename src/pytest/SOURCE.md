...
- `sketch2_test_vectors.py`: Shared f32/f16/f8/i16 quantization, bounded f8 codebook, formatting, and score-oracle helpers.
...
- `test_f8.py`: Cross-language E5M2 fixture, generator, conversion, and ctypes end-to-end tests.
