...
SKETCH_AVX2_TARGET inline double ComputeL1_AVX2::dist_f32(const uint8_t *a, const uint8_t *b, size_t dim) {
    if (dim % 8 == 0) {
...
SKETCH_AVX2_TARGET inline double ComputeL1_AVX2::dist_f32_8(const uint8_t *a, const uint8_t *b, size_t dim) {
    const float *va = reinterpret_cast<const float *>(a);
    const float *vb = reinterpret_cast<const float *>(b);
    const __m256 sign_mask = _mm256_set1_ps(-0.0f);
    __m256 acc0 = _mm256_setzero_ps();
...
SKETCH_AVX2_TARGET inline double ComputeL1_AVX2::dist_f16(const uint8_t *a, const uint8_t *b, size_t dim) {
...
SKETCH_AVX2_TARGET inline double ComputeL1_AVX2::dist_i16(const uint8_t *a, const uint8_t *b, size_t dim) {
    if (dim % 16 == 0) {
...
SKETCH_AVX2_TARGET inline double ComputeL1_AVX2::dist_i16_16(const uint8_t *a, const uint8_t *b, size_t dim) {
    const int16_t *va = reinterpret_cast<const int16_t *>(a);
    const int16_t *vb = reinterpret_cast<const int16_t *>(b);
    const __m256i zero = _mm256_setzero_si256();
    __m256i acc0 = _mm256_setzero_si256();
