...
struct DataFileHeader {
    ...
    uint32_t payload_crc32; // CRC32C over bytes [data_offset, file_size), when flag is set
    uint32_t reserved0;
...
// If kDataFileHasPayloadCrc32 is set, payload_crc32 stores CRC32C over bytes from
